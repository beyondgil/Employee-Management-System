...
public class ManagerRequestHandle extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "Human Resources":department="11111"+",";
		break;
		case "Technology":department="21111"+",";
		break;
		case "Marketing":department="31111"+",";
		break;
		case "Finance":department="41111"+",";
		break;
		default:department=",";break;
		}
